...
?>
<a id="<?=$idCompareCount;?>" class="position-relative<?/*=$mainClass;*/?>"<?/*=$style;*/?> href="/compare/">
...
if ($itemCount > 0) { ?>
    ...
    <span class="position-absolute top-0 left-100 translate-middle badge rounded-pill bg-danger text-white"><?=$itemCount;?></span>
